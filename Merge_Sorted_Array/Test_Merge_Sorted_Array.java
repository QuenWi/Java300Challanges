...
public class Test_Merge_Sorted_Array {
    ...
    public static void main(String[] args) {
        test(new Float[] {1f, 3.4f, 4.1f, 4.2f, 5f, 5.5f, 5.6f, 6f, 7.1f}, new Float[] {0.5f, 3.4f, 4f, 4.05f, 5.5f, 5.55f, 6.1f, 8f});
    }

    private static void test(Float[] array, Float[] mergeInto){
